...
class LidcIdriCollector(DataCollectorBase):
    ...
    LIDC_IDRI provides:
    - ct_scans, annotations
    """
    
    def __init__(self, output_dir: str = "data/external_sources/lidc_idri", **kwargs):
        ...
        self.data_types = self.config.get("data_types", ['ct_scans', 'annotations'])
    
    def collect_data(self, 
                    data_type: str = "ct_scans",
                    **kwargs) -> Dict[str, Any]:
        """
        Collect data from LIDC_IDRI.
        ...
        """
        self.logger.info(f"Collecting {data_type} data from LIDC_IDRI")
        ...
        try:
            ...
            mock_data = [
                {
                    "sample_id": f"lidc_idri_sample_{i}",
                    "data_type": data_type,
                    "value": i * 1.5,
                    "metadata": f"Sample {i} from lidc_idri"
                }
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from LIDC_IDRI."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"LIDC_IDRI {data_type} data for {cancer_type}",
