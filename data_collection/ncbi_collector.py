...
This module provides data collection capabilities for https://eutils.ncbi.nlm.nih.gov/entrez/eutils.
"""
...
class NcbiCollector(DataCollectorBase):
    ...
    NCBI provides:
    - sequences, annotations, variants
    """
    
    def __init__(self, output_dir: str = "data/external_sources/ncbi", **kwargs):
        ...
        self.data_types = self.config.get("data_types", ['sequences', 'annotations', 'variants'])
    ...
    def collect_data(self, 
        ...
        """
        self.logger.info(f"Collecting {data_type} data from NCBI")
        ...
        try:
            ...
            mock_data = [
                {
                    "sample_id": f"ncbi_sample_{i}",
                    "data_type": data_type,
                    "value": i * 1.5,
                    "metadata": f"Sample {i} from ncbi"
                }
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from NCBI."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"NCBI {data_type} data for {cancer_type}",
