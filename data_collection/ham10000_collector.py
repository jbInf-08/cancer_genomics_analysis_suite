...
This module provides data collection capabilities for https://www.nature.com.
"""
...
class Ham10000Collector(DataCollectorBase):
    ...
    def __init__(self, output_dir: str = "data/external_sources/ham10000", **kwargs):
        """Initialize ham10000 collector."""
        super().__init__(output_dir, **kwargs)
        self.base_url = self.config.get("base_url", "https://www.nature.com")
    ...
    def collect_data(self, 
        ...
        """
        self.logger.info(f"Collecting {data_type} data from HAM10000")
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from HAM10000."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"HAM10000 {data_type} data for {cancer_type}",
