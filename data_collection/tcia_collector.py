...
class TciaCollector(DataCollectorBase):
    ...
    def __init__(self, output_dir: str = "data/external_sources/tcia", **kwargs):
        ...
        self.cancer_types = self.config.get("cancer_types", ['breast', 'lung', 'brain', 'prostate'])
        self.data_types = self.config.get("data_types", ['imaging', 'radiology', 'pathology'])
    ...
    def collect_data(self, 
        ...
        """
        self.logger.info(f"Collecting {data_type} data from TCIA")
        ...
        try:
            ...
            mock_data = [
                {
                    "sample_id": f"tcia_sample_{i}",
                    "data_type": data_type,
                    "value": i * 1.5,
                    "metadata": f"Sample {i} from tcia"
                }
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from TCIA."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"TCIA {data_type} data for {cancer_type}",
