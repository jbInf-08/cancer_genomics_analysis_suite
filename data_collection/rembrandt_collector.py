...
class RembrandtCollector(DataCollectorBase):
    ...
    REMBRANDT provides:
    - mri, genomics, clinical
    """
    
    def __init__(self, output_dir: str = "data/external_sources/rembrandt", **kwargs):
        ...
        self.data_types = self.config.get("data_types", ['mri', 'genomics', 'clinical'])
    ...
    def collect_data(self, 
        ...
        """
        self.logger.info(f"Collecting {data_type} data from REMBRANDT")
        ...
        try:
            ...
            mock_data = [
                {
                    "sample_id": f"rembrandt_sample_{i}",
                    "data_type": data_type,
                    "value": i * 1.5,
                    "metadata": f"Sample {i} from rembrandt"
                }
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from REMBRANDT."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"REMBRANDT {data_type} data for {cancer_type}",
