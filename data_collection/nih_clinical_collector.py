...
class NihClinicalCollector(DataCollectorBase):
    ...
    NIH_CLINICAL provides:
    - clinical_trials, protocols, results
    """
    
    def __init__(self, output_dir: str = "data/external_sources/nih_clinical", **kwargs):
    ...
    def collect_data(self, 
                    ...
                    **kwargs) -> Dict[str, Any]:
        """
        Collect data from NIH_CLINICAL.
        ...
        """
        self.logger.info(f"Collecting {data_type} data from NIH_CLINICAL")
        ...
        try:
            ...
            mock_data = [
                {
                    "sample_id": f"nih_clinical_sample_{i}",
                    "data_type": data_type,
                    "value": i * 1.5,
                    "metadata": f"Sample {i} from nih_clinical"
                }
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from NIH_CLINICAL."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"NIH_CLINICAL {data_type} data for {cancer_type}",
