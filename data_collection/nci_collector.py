...
This module provides data collection capabilities for https://api.cancer.gov.
"""
...
class NciCollector(DataCollectorBase):
    ...
    NCI provides:
    - clinical_trials, drugs, statistics
    """
    
    def __init__(self, output_dir: str = "data/external_sources/nci", **kwargs):
        """Initialize nci collector."""
        super().__init__(output_dir, **kwargs)
        self.base_url = self.config.get("base_url", "https://api.cancer.gov")
        ...
        self.data_types = self.config.get("data_types", ['clinical_trials', 'drugs', 'statistics'])
    ...
    def collect_data(self, 
        ...
        """
        self.logger.info(f"Collecting {data_type} data from NCI")
        ...
        try:
            ...
            mock_data = [
                {
                    "sample_id": f"nci_sample_{i}",
                    "data_type": data_type,
                    "value": i * 1.5,
                    "metadata": f"Sample {i} from nci"
                }
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from NCI."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"NCI {data_type} data for {cancer_type}",
