...
This module provides data collection capabilities for https://www.mammoimage.org.
"""
...
class DdsmCollector(DataCollectorBase):
    ...
    def __init__(self, output_dir: str = "data/external_sources/ddsm", **kwargs):
        """Initialize ddsm collector."""
        super().__init__(output_dir, **kwargs)
        self.base_url = self.config.get("base_url", "https://www.mammoimage.org")
    ...
    def collect_data(self, 
        ...
        """
        self.logger.info(f"Collecting {data_type} data from DDSM")
        ...
        try:
            ...
            mock_data = [
                {
                    "sample_id": f"ddsm_sample_{i}",
                    "data_type": data_type,
                    "value": i * 1.5,
                    "metadata": f"Sample {i} from ddsm"
                }
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from DDSM."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"DDSM {data_type} data for {cancer_type}",
