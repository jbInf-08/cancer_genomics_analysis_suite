...
This module provides data collection capabilities for https://dcc.icgc.org/api/v1.
"""
...
class IcgcCollector(DataCollectorBase):
    ...
    def __init__(self, output_dir: str = "data/external_sources/icgc", **kwargs):
        """Initialize icgc collector."""
        super().__init__(output_dir, **kwargs)
        self.base_url = self.config.get("base_url", "https://dcc.icgc.org/api/v1")
    ...
    def collect_data(self, 
        ...
        """
        self.logger.info(f"Collecting {data_type} data from ICGC")
    ...
    def get_available_datasets(self) -> List[Dict[str, Any]]:
        """Get list of available datasets from ICGC."""
        datasets = []
        ...
        for data_type in self.data_types:
            for cancer_type in self.cancer_types:
                datasets.append({
                    ...
                    "description": f"ICGC {data_type} data for {cancer_type}",
