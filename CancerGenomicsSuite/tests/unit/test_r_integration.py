...
from CancerGenomicsSuite.modules.r_integration.r_client import RPY2_AVAILABLE, RClient
...
class TestRClientInitialization:
    ...
    def test_client_initializes_without_rpy2(self):
        ...
        with patch(
            "CancerGenomicsSuite.modules.r_integration.r_client.RPY2_AVAILABLE", False
        ):
...
class TestDataConversion:
    ...
    def test_load_dataframe(self):
        ...
        df = pd.DataFrame(
            {"gene": ["TP53", "BRCA1", "EGFR"], "expression": [100.5, 200.3, 150.7]}
        )
