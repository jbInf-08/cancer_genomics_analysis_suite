...
def test_config_utilities():
    ...
    try:
        ...
        print(
            f"✓ Gene expression analysis enabled: {get_feature_status('enable_gene_expression_analysis')}"
        )
...
def main():
    ...
    tests = [test_config_import, test_config_validation, test_config_utilities]
