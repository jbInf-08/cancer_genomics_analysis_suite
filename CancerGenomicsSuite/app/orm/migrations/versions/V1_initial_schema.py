...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_file_type_status", "data_files", ["file_type", "processing_status"]
    )
    ...
    op.create_index(
        "idx_gene_expression_gene_symbol", "gene_expression", ["gene_symbol"]
    )
    ...
    op.create_index(
        "idx_gene_condition", "gene_expression", ["gene_symbol", "condition"]
    )
    op.create_index(
        "idx_sample_condition", "gene_expression", ["sample_id", "condition"]
    )
    ...
    op.create_index(
        "idx_mutation_records_clinical_significance",
        "mutation_records",
        ["clinical_significance"],
    )
    op.create_index("idx_mutation_records_source", "mutation_records", ["source"])
    op.create_index(
        "idx_mutation_records_cancer_type", "mutation_records", ["cancer_type"]
    )
    ...
    op.create_index(
        "idx_chromosome_position", "mutation_records", ["chromosome", "position"]
    )
    op.create_index(
        "idx_clinical_significance",
        "mutation_records",
    ...
    op.create_index(
        "idx_analysis_results_result_type", "analysis_results", ["result_type"]
    )
    op.create_index(
        "idx_analysis_results_created_at", "analysis_results", ["created_at"]
    )
    op.create_index(
        "idx_job_result_type", "analysis_results", ["job_id", "result_type"]
    )
    op.create_index(
        "idx_result_type_created", "analysis_results", ["result_type", "created_at"]
    )
    op.create_index(
        "idx_is_public_created", "analysis_results", ["is_public", "created_at"]
    )
    ...
    op.create_index(
        "idx_ngs_samples_sequencing_type", "ngs_samples", ["sequencing_type"]
    )
    ...
    op.create_index(
        "idx_ngs_pipelines_pipeline_type", "ngs_pipelines", ["pipeline_type"]
    )
    ...
    op.create_index(
        "idx_docker_containers_container_id", "docker_containers", ["container_id"]
    )
    ...
    op.create_index(
        "idx_notification_channels_channel_name",
        "notification_channels",
        ["channel_name"],
    )
    op.create_index(
    ...
    op.create_index(
        "idx_notification_channels_is_active", "notification_channels", ["is_active"]
    )

    op.create_index(
        "idx_alert_notifications_alert_id", "alert_notifications", ["alert_id"]
    )
    op.create_index(
        "idx_alert_notifications_channel_id", "alert_notifications", ["channel_id"]
    )
    op.create_index("idx_alert_notifications_status", "alert_notifications", ["status"])

    op.create_index(
        "idx_email_templates_template_name", "email_templates", ["template_name"]
    )
    op.create_index(
        "idx_email_templates_template_type", "email_templates", ["template_type"]
    )
    ...
    op.create_index(
        "idx_system_metrics_metric_name_time",
        "system_metrics",
        ["metric_name", "timestamp"],
    )
    op.create_index(
        "idx_system_metrics_metric_type_time",
        "system_metrics",
        ["metric_type", "timestamp"],
    )

    op.create_index(
        "idx_health_checks_check_name_time",
        "health_checks",
        ["check_name", "checked_at"],
    )
    op.create_index(
        "idx_health_checks_check_type_time",
        "health_checks",
