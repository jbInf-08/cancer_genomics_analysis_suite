...
def run_multi():
    ...
    workers = [
        ...
        {"name": "mutation_analysis", "queues": "mutation_analysis", "concurrency": 1},
        {"name": "ml_prediction", "queues": "ml_prediction", "concurrency": 1},
        {"name": "reporting", "queues": "reporting,integration", "concurrency": 1},
    ]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run Celery workers for Cancer Genomics Analysis Suite"
    )
    parser.add_argument(
        "command",
        choices=["worker", "beat", "flower", "multi", "check"],
        help="Command to run",
    )
