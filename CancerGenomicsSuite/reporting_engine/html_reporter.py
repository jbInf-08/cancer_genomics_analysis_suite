...
class HTMLReporter:
    ...
    def set_metadata(
        self,
        title: str,
        author: str = "Cancer Genomics Analysis Suite",
    ...
    def add_table_section(self, title: str, df: pd.DataFrame, interactive: bool = True):
        """
    ...
    def add_chart_section(self, title: str, fig: go.Figure, chart_type: str = "plotly"):
        """
        ...
        if chart_type == "plotly":
            ...
            chart_html = (
                f'<img src="data:image/png;base64,{img_base64}" class="img-fluid">'
            )

        self.add_section(title, chart_html, "chart")

    def create_bar_chart(
        self, data: Dict[str, Any], title: str = "Bar Chart"
    ) -> go.Figure:
        """
    ...
    def create_line_chart(
        self, data: Dict[str, Any], title: str = "Line Chart"
    ) -> go.Figure:
        """
    ...
    def create_scatter_plot(
        self, data: Dict[str, Any], title: str = "Scatter Plot"
    ) -> go.Figure:
        """
...
<body>
    ...
    def save_report(
        self, output_path: str, template_name: str = "report_template.html"
    ) -> str:
        """
    ...
    def create_analysis_report(
        ...
        self.set_metadata(
            ...
            description=analysis_data.get(
                "description", "Comprehensive genomics analysis results"
            ),
        )
        ...
        if "tables" in analysis_data:
            for table_info in analysis_data["tables"]:
                self.add_table_section(
                    table_info.get("title", "Results Table"), table_info["data"]
                )
        ...
        if "conclusions" in analysis_data:
            conclusions_text = "<br>".join(
                [f"• {c}" for c in analysis_data["conclusions"]]
            )
