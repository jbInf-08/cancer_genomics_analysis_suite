...
if "dash" not in sys.modules:
    ...
    sys.modules["dash.dependencies"] = type(
        "MockDeps",
        (),
        {
...
layout = html.Div(
    [
        ...
        html.P(
            "This is a demonstration module showing how to create a dashboard component.",
        ...
        html.Div(
            [
                ...
                html.Button(
                    "Analyze Data", id="demo-analyze-btn", className="demo-button"
                ),
...
def register_callbacks(app):
    ...
    try:
        ...
        def analyze_data(n_clicks, input_data):
            ...
            return html.P(
                "Enter some data and click 'Analyze Data' to see results.",
