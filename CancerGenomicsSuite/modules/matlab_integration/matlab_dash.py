    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Execute MATLAB code, run numerical computations, and perform signal processing",
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    id="matlab-version", className="status-value"
                                ),
                            ],
                            className="status-item",
                        ),
                        html.Div(
                            [
                                ...
                                html.Span(
                                    id="matlab-toolboxes", className="status-value"
                                ),
                            ],
                            className="status-item",
                        ),
            ...
            [
                ...
                html.Div(
                    [
                        html.Button(
                            "Execute MATLAB Code",
                            id="execute-matlab-code",
                            className="button primary",
                        ),
                        html.Button(
                            "Clear",
                            id="clear-matlab-code",
                            className="button secondary",
                        ),
                        html.Button(
                            "Load Example",
                            id="load-matlab-example",
                            className="button secondary",
                        ),
                    ],
                ...
                html.Div(
                    [
                        html.Div(
                            [
                                html.Label(
                                    "Objective Function:", className="input-label"
                                ),
                                dcc.Textarea(
                        ...
                        html.Div(
                            id="optimization-results", className="optimization-results"
                        ),
                    ],
...
def register_callbacks(app):
    ...
    def execute_matlab_code(n_clicks, matlab_code):
        ...
        if not matlab_client.is_available():
            status = html.Span(
                "❌ MATLAB engine not available", className="error-message"
            )
            return status, ""
        ...
        try:
            ...
            if result["success"]:
                status = html.Div(
                    [
                        html.Span(
                            "✅ MATLAB code executed successfully",
                ...
                if result["output"]:
                    ...
                    output_content.append(
                        html.Pre(result["output"], className="code-output")
                    )

                if result["error_output"]:
                    output_content.append(html.H4("Messages:"))
                    output_content.append(
                        html.Pre(result["error_output"], className="code-messages")
                    )
                ...
                status = html.Div(
                    [
                        html.Span(
                            "❌ MATLAB code execution failed", className="error-message"
                        ),
                        html.Br(),
                        html.Span(
                ...
                return status, html.Pre(
                    result["error_output"], className="error-output"
                )
...
"""
    ...
    def run_optimization(n_clicks, objective_function, initial_guess, method):
        ...
        try:
            ...
            # Run optimization
            result = matlab_client.run_optimization(
                objective_function, initial_values, method
            )
