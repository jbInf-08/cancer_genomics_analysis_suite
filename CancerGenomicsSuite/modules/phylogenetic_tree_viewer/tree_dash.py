...
class TreeDashboard:
        ...
        return html.Div(
            [
                ...
                html.Div(
                    [
                        html.H1(
                            "Phylogenetic Tree Viewer", className="text-center mb-4"
                        ),
                        html.P(
                            "Comprehensive phylogenetic tree construction and visualization tools for cancer genomics research",
                        ...
                        html.Div(
                            [
                                ...
                                html.Div(
                                    [
                                        html.Label(
                                            "Upload Multiple Sequence Alignment (FASTA/PHYLIP/CLUSTAL):",
                                        ...
                                        html.Div(
                                            id="tree-upload-status", className="mt-3"
                                        ),
                                    ]
                                ),
                            ],
                                        ...
                                        html.Div(
                                            [
                                                dcc.Checklist(
                                                    ...
                                                    options=[
                                                        {
                                                            "label": "Generate Consensus Tree",
                                                            "value": "consensus",
                                                        },
                                                        {
                                                            "label": "Calculate Support Values",
                                                            "value": "support",
                                                        },
                                                        {
                                                            "label": "Optimize Branch Lengths",
                                                            "value": "optimize_branches",
                                                        },
                                                        {
                                                            "label": "Optimize Topology",
                                                            "value": "optimize_topology",
                                                        },
                                                    ],
                                    ...
                                    [
                                        html.Div(
                                            [
                                                ...
                                                dcc.Dropdown(
                                                    id="tree1-select", className="mb-2"
                                                ),
                                                html.Label(
                                                    "Select Tree 2:",
                                                    className="form-label",
                                                ...
                                                dcc.Dropdown(
                                                    id="tree2-select", className="mb-2"
                                                ),
                                                html.Button(
                                                    "Compare Trees",
                                                    id="compare-trees-btn",
    ...
    def _register_callbacks(self):
                    ...
                    if result["success"]:
                        ...
                        return (
                            html.Div(
                                [
                                    html.P(
                                        f"Successfully loaded {result['sequences']} sequences, length {result['alignment_length']}",
                        ...
                        return (
                            html.Div(
                                [
                                    html.P(
                                        f"Error loading alignment: {result['error']}",
        ...
        def build_tree(
            ...
            if n_clicks == 0 or self.builder.sequence_alignment is None:
                return (
                    html.P("Upload alignment data and click 'Build Tree'"),
                    html.Div(),
                    [],
                    [],
                )
            ...
            try:
                ...
                if result["success"]:
                    ...
                    tree_options = [
                        ...
                        for name in tree_summary["tree_names"]
                    ]
                    ...
                    return (
                        html.Div(
                            [
                                html.H4(
                                    "Tree Construction Error", className="text-danger"
                                ),
                                html.P(result["error"]),
                            ]
                        ),
        ...
        @self.app.callback(
            ...
            [State("tree1-select", "value"), State("tree2-select", "value")],
        )
    ...
    def _create_tree_results_display(self, result: Dict[str, Any]) -> html.Div:
        ...
        components.append(
            html.P(f"Construction Time: {result['construction_time']:.2f} seconds")
        )
        ...
        if "tree_statistics" in result:
            ...
            stats_data = [
                {
                    "Metric": "Tree Length",
                    "Value": f"{stats.get('tree_length', 0):.3f}",
                },
                {"Metric": "Number of Tips", "Value": stats.get("number_of_tips", 0)},
                {
                    "Metric": "Number of Internal Nodes",
                    "Value": stats.get("number_of_internal_nodes", 0),
                },
                {
                    "Metric": "Average Branch Length",
                    "Value": f"{stats.get('average_branch_length', 0):.3f}",
                },
                {
                    "Metric": "Min Branch Length",
                    "Value": f"{stats.get('min_branch_length', 0):.3f}",
                },
                {
                    "Metric": "Max Branch Length",
                    "Value": f"{stats.get('max_branch_length', 0):.3f}",
                },
            ]
        ...
        if "bootstrap_results" in result and result["bootstrap_results"]:
            ...
            if "error" not in bootstrap:
                ...
                components.append(
                    html.P(f"Bootstrap Replicates: {bootstrap['bootstrap_replicates']}")
                )
                components.append(
                    html.P(f"High Support Nodes: {bootstrap['high_support_nodes']}")
                )
                ...
                if "support_values" in bootstrap:
                    ...
                    for node, support in bootstrap["support_values"].items():
                        support_data.append(
                            {"Node": node, "Bootstrap Support": f"{support:.3f}"}
                        )
                    ...
                    if support_data:
                        components.append(
                            dash_table.DataTable(
                                data=support_data,
                                columns=[
                                    {"name": i, "id": i} for i in support_data[0].keys()
                                ],
                                style_cell={"textAlign": "left", "fontSize": 12},
                                style_header={
                                    "backgroundColor": "rgb(230, 230, 230)",
        ...
        try:
            ...
            return html.Div(
                [
                    ...
                    html.Img(
                        src=f"data:image/png;base64,{self._encode_image(viz_path)}",
    ...
    def _create_tree_comparison_display(self, comparison: Dict[str, Any]) -> html.Div:
        ...
        components.append(
            html.P(
                f"Robinson-Foulds Distance: {comparison['robinson_foulds_distance']}"
            )
        )
