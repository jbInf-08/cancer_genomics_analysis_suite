    ...
    def _interpolate_colors(self, n_colors: int) -> List[str]:
        ...
        for i in range(n_colors):
            ...
            if color_idx == int(color_idx):
                ...
                r = int(
                    rgb_colors[idx1][0] * (1 - weight) + rgb_colors[idx2][0] * weight
                )
                g = int(
                    rgb_colors[idx1][1] * (1 - weight) + rgb_colors[idx2][1] * weight
                )
                b = int(
                    rgb_colors[idx1][2] * (1 - weight) + rgb_colors[idx2][2] * weight
                )
...
class ThemeManager:
    ...
    def create_theme(
        self, name: str, theme_type: ThemeType, **kwargs
    ) -> VisualizationTheme:
        """
    ...
    def create_palette(
        self, name: str, palette_type: ColorPaletteType, colors: List[str], **kwargs
    ) -> ColorPalette:
        """
        ...
        palette = ColorPalette(
            name=name, palette_type=palette_type, colors=colors, **kwargs
        )
