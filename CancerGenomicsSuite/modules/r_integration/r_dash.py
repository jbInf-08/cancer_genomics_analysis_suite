    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Execute R code, run statistical analyses, and create visualizations",
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.Button(
                            "Clear", id="clear-r-code", className="button secondary"
                        ),
                        html.Button(
                            "Load Example",
                            id="load-example",
...
def register_callbacks(app):
    ...
    @app.callback(
        [Output("r-execution-status", "children"), Output("r-results", "children")],
            ...
            if result["success"]:
                ...
                if result["stdout"]:
                    ...
                    output_content.append(
                        html.Pre(result["stdout"], className="code-output")
                    )

                if result["stderr"]:
                    output_content.append(html.H4("Messages:"))
                    output_content.append(
                        html.Pre(result["stderr"], className="code-messages")
                    )
                ...
                status = html.Div(
                    [
                        html.Span(
                            "❌ R code execution failed", className="error-message"
                        ),
                        html.Br(),
                        html.Span(
    ...
    @app.callback(
        ...
        [Input("clear-r-code", "n_clicks"), Input("load-example", "n_clicks")],
    )
...
"""
    ...
    @app.callback(
        ...
        [State("package-name", "value"), State("package-source", "value")],
    )
    ...
    @app.callback(
        ...
        [State("gene-list", "value"), State("pvalue-cutoff", "value")],
    )
