    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Bioinformatics workflows and analysis",
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.Span(
                                    id="tamarind-status", className="status-value"
                                ),
                            ],
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    id="tamarind-version", className="status-value"
                                ),
                            ],
                            className="status-item",
                        ),
                ...
                html.Div(
                    [
                        ...
                        dcc.Upload(
                            id="workflow-upload",
                            children=html.Div(
                                ["Drag and Drop or ", html.A("Select Workflow File")]
                            ),
                            style={
                                "width": "100%",
                                "height": "60px",
...
def register_callbacks(app):
    ...
    @app.callback(
        [Output("tamarind-status", "children"), Output("tamarind-version", "children")],
