    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Neuroscience data analysis and processing",
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.Span(
                                    id="neurosnap-status", className="status-value"
                                ),
                            ],
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    id="neurosnap-version", className="status-value"
                                ),
                            ],
                            className="status-item",
                        ),
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        ...
                        dcc.Upload(
                            ...
                            children=html.Div(
                                ["Drag and Drop or ", html.A("Select Neural Data File")]
                            ),
                            style={
                                "width": "100%",
                                "height": "60px",
                ...
                html.Button(
                    "Run Analysis", id="run-neural-analysis", className="button primary"
                ),
...
def register_callbacks(app):
    ...
    @app.callback(
        ...
        [State("neural-data-upload", "contents"), State("analysis-type", "value")],
    )
