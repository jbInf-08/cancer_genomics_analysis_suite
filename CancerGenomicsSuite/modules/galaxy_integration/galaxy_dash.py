    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Access Galaxy workflows, tools, and data analysis capabilities",
        ...
        html.Div(
            [
                ...
                html.Button(
                    "Connect to Galaxy", id="connect-galaxy", className="button primary"
                ),
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            id="workflow-parameters", className="parameters-container"
                        ),
                    ],
                    className="input-group",
                ),
...
def register_callbacks(app):
    ...
    @app.callback(
        [Output("connection-status", "children"), Output("galaxy-data", "children")],
        [Input("connect-galaxy", "n_clicks")],
        [State("galaxy-url", "value"), State("galaxy-api-key", "value")],
    )
        ...
        try:
            ...
            if workflows:
                status = html.Div(
                    [
                        html.Span(
                            "✅ Connected to Galaxy successfully",
                ...
                return (
                    html.Span(
                        "⚠️ Connected but no workflows found",
            ...
            return (
                html.Span(f"❌ Connection failed: {str(e)}", className="error-message"),
                "",
            )

    @app.callback(
        Output("workflows-list", "children"),
        [Input("refresh-workflows", "n_clicks"), Input("galaxy-data", "children")],
    )
    ...
    @app.callback(
        ...
        [Input("refresh-tools", "n_clicks"), Input("tool-search", "value")],
    )
    ...
    @app.callback(
        Output("results-container", "children"), [Input("check-status", "n_clicks")]
    )
