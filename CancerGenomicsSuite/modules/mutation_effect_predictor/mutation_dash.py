            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.P(
                            "Predict the functional impact of genetic mutations using multiple algorithms",
                            ...
                            [
                                ...
                                dcc.Dropdown(
                                    ...
                                    options=[
                                        ...
                                        {
                                            "label": "Mouse NCBIM37 (mm9)",
                                            "value": "mm9",
                                        },
                                        {
                                            "label": "Drosophila BDGP6 (dm6)",
                                            "value": "dm6",
                                        },
                                        {
                                            "label": "C. elegans WBcel235 (ce11)",
                                            "value": "ce11",
                                        },
                                    ],
                                    value="hg38",
                        ...
                        html.Div(
                            [
                                html.Span(
                                    [
                                        html.Label(
                                            "Position convention (overlap window)"
                                        ),
                                        html.Span(
                                            " ⓘ",
                                            title=(
                                ...
                                dcc.Dropdown(
                                    ...
                                    options=[
                                        {
                                            "label": "1-based VCF POS (recommended)",
                                            "value": "one_based_vcf",
                                        },
                                        {
                                            "label": "0-based center (legacy)",
                                            "value": "zero_based_center",
                                        },
                                    ],
                                    value="one_based_vcf",
                                    clearable=False,
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            id="consensus-analysis", className="consensus-analysis"
                        ),
                    ],
    ...
    def setup_callbacks(self):
        ...
        def run_prediction(
            ...
            if button_id == "load-samples-button" and load_samples_clicks:
                ...
                for mutation in sample_mutations:
                    results = self.predictor.predict_mutation_effect(
                        mutation, selected_predictors
                    )
        ...
        def annotate_locus_with_ensembl(
            ...
            if not chromosome or position is None:
                return html.P(
                    "Chromosome and position are required.", className="error-message"
                )
            ...
            if genes and (
                ...
                or (
                    isinstance(genes[0].get("error"), str)
                    and genes[0].get("source") == "ensembl"
                )
            ):
        ...
        def run_md_from_mutation_dashboard(
            ...
            workflow_name = f"md_mutation_dash_{datetime.now().strftime('%Y%m%d_%H%M%S')}_{wf_suffix}"
        ...
        def export_results(export_clicks, format_type):
            ...
            try:
                exported_data = self.predictor.export_predictions(
                    self.current_predictions, format_type
                )
        ...
        def update_statistics(predict_clicks, load_samples_clicks):
            ...
            return html.Div(
                [
                    html.P(
                        [
                            html.Strong("Available Predictors: "),
                            ", ".join(stats["available_predictors"]),
                            html.Br(),
                            html.Strong("Supported Mutation Types: "),
                            ", ".join(stats["supported_mutation_types"]),
                            html.Br(),
                            html.Strong("Prediction Classes: "),
                            ", ".join(stats["prediction_classes"]),
                            html.Br(),
                            html.Strong("Cache Size: "),
                            str(stats["cache_size"]),
                            html.Br(),
                            html.Strong("Model Loaded: "),
                            "Yes" if stats["model_loaded"] else "No",
                        ]
                    )
                ]
            )
        ...
        for mutation_key, results in mutation_groups.items():
            ...
            summary_items.append(
                html.Div(
                    [
                        html.H4(
                            f"{mutation.gene_symbol} {mutation.ref_amino_acid}{mutation.protein_position}{mutation.alt_amino_acid}"
                        ),
                        html.P(
                            [
                                html.Strong("Location: "),
                                f"{mutation.chromosome}:{mutation.position:,}",
                                html.Br(),
                                html.Strong("Change: "),
                                f"{mutation.ref_allele} → {mutation.alt_allele}",
                                html.Br(),
        ...
        for mutation_key, results in mutation_groups.items():
            ...
            consensus_items.append(
                html.Div(
                    [
                        html.H4(
                            f"Consensus for {mutation.gene_symbol} {mutation.ref_amino_acid}{mutation.protein_position}{mutation.alt_amino_acid}"
                        ),
                        html.P(
                            [
                                html.Strong("Consensus Class: "),
                                consensus["consensus_class"],
                                html.Br(),
                                html.Strong("Agreement Ratio: "),
                                f"{consensus['consensus_ratio']:.2f}",
                                html.Br(),
                                html.Strong("Average Confidence: "),
                                f"{consensus['average_confidence']:.2f}",
                                html.Br(),
                                html.Strong("Total Predictors: "),
                                str(consensus["total_predictors"]),
                            ]
                        ),
                        html.Details(
                            [
                                ...
                                html.Ul(
                                    [
                                        ...
                                        for class_name, count in consensus[
                                            "class_distribution"
                                        ].items()
                                    ]
                                ),
            ...
            table_data.append(
                {
                    ...
                    "Protein Change": f"{result.mutation.ref_amino_acid}{result.mutation.protein_position}{result.mutation.alt_amino_acid}"
                    if result.mutation.protein_position
                    else "N/A",
                    "Predictor": result.predictor_name,
