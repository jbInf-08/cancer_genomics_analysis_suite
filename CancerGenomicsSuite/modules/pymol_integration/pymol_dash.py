    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Molecular visualization, structure analysis, and protein modeling",
            ...
            [
                ...
                html.Div(
                    [
                        ...
                        html.Button(
                            "Visualize Structure",
                            id="visualize-structure",
                            className="button primary",
                        ),
                        html.Div(
                            id="visualization-results",
                            className="visualization-results",
                        ),
                    ],
            ...
            [
                ...
                html.Div(
                    [
                        html.Button(
                            "Execute Commands",
                            id="execute-pymol-commands",
                            className="button primary",
                        ),
                        html.Button(
                            "Clear",
                            id="clear-pymol-commands",
                            className="button secondary",
                        ),
                        html.Button(
                            "Load Example",
                            id="load-pymol-example",
                            className="button secondary",
                        ),
                    ],
...
def register_callbacks(app):
    ...
    @app.callback(
        ...
        [State("pdb-id", "value"), State("pdb-object-name", "value")],
    )
    ...
    def visualize_structure(n_clicks, object_name, style, color):
        ...
        try:
            ...
            # Visualize structure
            result = pymol_client.visualize_structure(
                object_name, style, color, output_file
            )
