    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Read simulation and variant calling tools",
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        ...
                        dcc.Upload(
                            id="reference-upload",
                            children=html.Div(
                                ["Drag and Drop or ", html.A("Select Reference Genome")]
                            ),
                            style={
                                "width": "100%",
                                "height": "60px",
                ...
                html.Button(
                    "Simulate Reads", id="simulate-reads", className="button primary"
                ),
...
def register_callbacks(app):
    ...
    @app.callback(
        [Output("wgsim-status", "children"), Output("dwgsim-status", "children")],
        [Input("refresh-wgsim-status", "n_clicks")],
    )
    def update_wgsim_status(n_clicks):
        wgsim_status = (
            "✅ Available" if wgsim_client.is_wgsim_available() else "❌ Not Available"
        )
        dwgsim_status = (
            "✅ Available" if wgsim_client.is_dwgsim_available() else "❌ Not Available"
        )
