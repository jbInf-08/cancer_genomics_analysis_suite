...
class Auth0Client:
    ...
    def get_well_known_config(self) -> Dict[str, Any]:
        ...
        # Check cache
        if (
            self._well_known_config
            and self._config_cache_time
            and datetime.now() - self._config_cache_time < timedelta(hours=1)
        ):
    ...
    def get_authorization_url(
        self, redirect_uri: str, state: str, scopes: List[str] = None
    ) -> str:
        """
    ...
    def search_users(
        self, query: str, management_token: str, max_results: int = 100
    ) -> List[Dict[str, Any]]:
        """
        ...
        params = {"q": query, "per_page": min(max_results, 100), "page": 0}
    ...
    def update_user_metadata(
        self, user_id: str, metadata: Dict[str, Any], management_token: str
    ) -> bool:
        """
    ...
    def assign_roles_to_user(
        self, user_id: str, roles: List[str], management_token: str
    ) -> bool:
        """
