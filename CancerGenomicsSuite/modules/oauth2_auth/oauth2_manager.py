...
try:
    ...
    logging.warning(
        "OAuth2 libraries not available. Install authlib and python-jose packages."
    )
...
class OAuth2Manager:
    ...
    def _register_routes(self):
        ...
        def logout():
            """Logout user."""
            session_id = self.app.request.headers.get("Authorization", "").replace(
                "Bearer ", ""
            )
