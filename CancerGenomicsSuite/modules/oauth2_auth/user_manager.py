...
class UserManager:
    ...
    def create_or_update_user(
        self, user_info: Dict[str, Any], provider: str = "oauth2"
    ) -> Dict[str, Any]:
        """
    ...
    def _create_user(self, user_info: Dict[str, Any], provider: str) -> Dict[str, Any]:
        """Create a new user."""
        user_id = user_info.get("id")
        username = user_info.get("username")
    ...
    def _update_user(
        self, existing_user: Dict[str, Any], user_info: Dict[str, Any], provider: str
    ) -> Dict[str, Any]:
        """Update existing user."""
        ...
        if "roles" in user_info and user_info["roles"]:
            ...
            existing_user["permissions"] = self._get_user_permissions(
                existing_user["roles"]
            )
    ...
    def load_users_from_config(self, users_config: List[Dict[str, Any]]):
        ...
        for user_config in users_config:
            ...
            user = {
                ...
                "settings": {
                    **self.default_settings,
                    **user_config.get("settings", {}),
                },
                "permissions": self._get_user_permissions(
                    user_config.get("roles", ["viewer"])
                ),
