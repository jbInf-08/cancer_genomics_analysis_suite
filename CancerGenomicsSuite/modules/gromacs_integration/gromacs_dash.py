    ...
    [
                    ...
                    [
                        html.Div(
                            [
                                ...
                                html.Span(
                                    id="gromacs-status", className="status-value"
                                ),
                            ],
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    id="gromacs-version", className="status-value"
                                ),
                            ],
                            className="status-item",
                        ),
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        ...
                        dcc.Upload(
                            ...
                            children=html.Div(
                                ["Drag and Drop or ", html.A("Select GROMACS Files")]
                            ),
                            style={
                                "width": "100%",
                                "height": "60px",
                ...
                html.Button(
                    "Run Simulation", id="run-simulation", className="button primary"
                ),
                html.Div(
                    id="gromacs-simulation-results", className="simulation-results"
                ),
            ],
...
def register_callbacks(app):
    ...
    @app.callback(
        [Output("gromacs-status", "children"), Output("gromacs-version", "children")],
