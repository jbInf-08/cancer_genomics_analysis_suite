...
class TextEditorClient:
    ...
    def open_file(
        self, file_path: str, editor: str = "nano", line_number: Optional[int] = None
    ) -> Dict[str, Any]:
        """
        ...
        if editor not in self.available_editors:
            return {"success": False, "error": f"Editor {editor} not available"}
    ...
    def create_temp_file(
        self, content: str = "", suffix: str = ".txt", editor: str = "nano"
    ) -> Dict[str, Any]:
        """
    ...
    def search_in_file(
        ...
        try:
            ...
            for line_num, line in enumerate(lines, 1):
                ...
                search_term_lower = (
                    search_term if case_sensitive else search_term.lower()
                )
    ...
    def replace_in_file(
        ...
        try:
            ...
            if case_sensitive:
                ...
                new_content = re.sub(
                    pattern, replace_term, content, flags=re.IGNORECASE
                )
    ...
    def get_editor_info(self, editor: str) -> Dict[str, Any]:
        ...
        return {"success": True, "editor": editor, "info": info}
