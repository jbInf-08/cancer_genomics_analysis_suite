    ...
    [
        html.Div(
            [
                ...
                html.P(
                    "Genomic data visualization and analysis",
...
def register_callbacks(app):
    ...
    @app.callback(
        [Output("igv-status", "children"), Output("igv-version", "children")],
    ...
    @app.callback(
        ...
        [State("track-file-upload", "contents"), State("track-name", "value")],
    )
